				...
				<div className="about_us_text_wrap mx-auto">
					<div className="about_us_text">
						<div className="policy_text_inner">
							...
							<p>
								1.3. Anti-Money Laundering Policy means program on prevention of
								laundering of money derived from criminal activity and financing
								of terrorism, which constitutes an essential part of the
							...
							<p>
								1.5. Cryptocurrency means peer-to-peer digital currency that has
								no central issuer and is distributed directly between the owners
								of such currency.
							</p>
							<p>
							...
							<p>
								...
								08345572 of the 3rd of January, 2013, including but not limited
								by employees, officers, directors and shareholders, affiliated
								persons of KOINKOIN LTD. KOINKOIN LTD is wholly owned by SJ
								Finanzmann Limited (hereinafter referred to as KOINKOIN) and was
								incorporated under the International Business Companies Act of
								1994 of the Republic of Seychelles with a company number of
								204414 and registered address of Global Gateway 8, Rue de la
								Perl, Providence, Mahe, Seychelles. Depending on the context
								KOINKOIN also may mean services, products, web-sites, content
								and other materials, provided by KOINKOIN.
							</p>
							<p>
								1.9. Exchange Rate means relation between the amount of Funds
								and the price offered by the User for Deals of exchanging Funds.
							</p>
							<p>
							...
							<p>
								1.13. Margin Deal means deal executed with the use of the Funds
								provided by to the Client in returned and refundable use.
							</p>
							<p>
								1.14. Margin Level means the amount of Funds in the User Account
								necessary for execution of a Margin Deal expressed in a
								percentage ratio to the amount of Funds provided to the User.
							</p>
							<p>
							...
							<p>
								1.17. Personal Cabinet means set of protected pages created as a
								result of the User registration in the System, using which the
								User can to place Orders for further execution of Deals as well
								as instruct the KOINKOIN commissions stipulated by the present
								Agreement. The Personal Cabinet reflects information about
								placed and cancelled Orders, closed Deals, available funds
								and/or Cryptocurrency and other information determined by the
							...
							<p>
								1.23. User Account Data means User Data necessary to access and
								use the System – login, password, email and other data indicated
							...
							<p>
								...
								volume of trading operations that it can perform at the expense
								of the Funds granted to it under a Loan agreement.
							</p>
							<p>
								The rest of terms and definitions that can be found in the text
								of the Agreement should be interpreted by the Parties according
								to the legislation of the UK and to the general rules of
								interpretation of such terms accepted in the Internet network.
							</p>
							<p>
							...
							<p>
								...
								following services:
								<br />
								<i className="small fa fa-circle" /> grants access to the System
								in order to carry out Deals;
								<br />
							...
							<p>
								...
								User’s responsibility to follow those rules and laws in his/her
								place of residence and/or place from which the User accesses
								this Site.
							</p>
							<p>
							...
							<p>
								...
								the System, Currency Rates offered by other Users, closed Deals
								and about placed Orders before the registration process is
								completed.
							</p>
							<p>
								3.2. In order to get access to the System, the User should
								complete the registration process. After that the User will get
								access to the Personal Cabinet created on the basis of the User
								Account Data.
							</p>
							<p>
								...
								access of third parties and is the one to determine the best way
								to save this data and take steps to prevent it from being
								discredited. In case of loss or discrediting the password and/or
								the User Account Data as well as in cases when third parties
								illegally obtain access to the User’s Personal Cabinet, the User
								has to inform the KOINKOIN about these circumstances by
								contacting the technical support team (support@koinkoin.com).
								Until KOINKOIN receives the corresponding message, all the
								actions made from the User Personal Cabinet will be considered
								as made by the proper User as the holder of the Account.
							</p>
							<p>
							...
							<p>
								...
								violation of the rules of chat use and may result in a permanent
								ban of the User;
								<br />
								<i className="small fa fa-circle" /> use any forms of obscene
								language;
								<br />
								<i className="small fa fa-circle" /> make statements stirring up
								to international dissention, containing violence propaganda or
								offending religious feelings of other Users;
								<br />
							...
							<p>
								4.2. The KOINKOIN platform indicates in the Personal Cabinet the
								information necessary for the replenishment of the Account and
								for the withdrawal of Funds from the Account.
							</p>
							<p>
								4.3. To replenish the Account the User has to transfer Funds
								according to the bank details indicated by KOINKOIN in the User
								Personal Cabinet. The User is responsible for paying commissions
								and service fees related to the transfer as well as assume the
								risks of indicating an incorrect bank account details.
							</p>
							<p>
								4.4. The Account is considered to be replenished when the
								corresponding amount of money enters the current account of
								KOINKOIN or when a corresponding message appears in the KOINKOIN
								wallet about receiving not less than 6 (six) confirmations.
							</p>
							<p>
							...
							<p>
								...
								transferred to the Account and does not keep Users’ money. Money
								transfers during the Account replenishment as well while
								executing Deals between the Users are carried out by third
								parties (aggregators, payment institutions and other
								facilitators). KOINKOIN is not liable for actions of these third
								parties.
							</p>
							<p>
								4.7. All Account operations are carried out at User’s request.
								The KOINKOIN platform does not accept orders on carrying out any
								operation with the User Account from third persons except
								otherwise is stipulated by the Agreement or other agreements
								between the Parties.
							</p>
							<p>
								4.8. All the Funds placed on the Account belong to the User. The
								KOINKOIN platform cannot block Funds on the Account without the
								order emitted by the User as well as can write-off Funds only in
								cases stipulated by the Agreement.
							</p>
							<p>
								4.9. Interests do not apply to the remainder amount of Funds in
								the User Account, and KOINKOIN is not committed to pay the
								abovementioned interests.
							</p>
							<p>
								4.10. To withdraw Funds from the Account, the User has to fill
								the corresponding form in their Personal Cabinet. The User will
								get a message to the email address indicated during the
								registration process asking to confirm or to deny the withdrawal
								operation. In case the User denies or does not confirm the
								withdrawal, the Funds will remain in the Account.
							</p>
							<p>
							...
							<p>
								...
								bank verifications and checks, for a period up to one (1) month.
								Similarly and due to the inherent nature of the cryptocurrency
								networks, the User acknowledges and agrees that depositing and
								withdrawing Cryptocurrencies into/from his/her Account may take
								between one (1) hour and seventy two (72) hours, barring
								unforeseen or unavoidable network issues.
							</p>
							<p>
							...
							<p>
								...
								KOINKOIN reserves the right to freeze the Account until the end
								of investigation.
							</p>
							<p>
								...
								Funds from User`s Accounts. In such cases the User is obliged to
								cooperate with KOINKOIN in order to discover the reasons for
								such request.
							</p>
							<h3>5. TRADING DEALS</h3>
							<p>
								5.1. The Deals in the System are made on the basis of Orders
								placed by the User and according to the conditions stipulated by
								the Parties, taking into consideration the preliminary
							...
							<p>
								5.4. To place an Order The User has to replenish the Account for
								the amount indicated in the Order and fill the corresponding
								form in the page ‘Trades’ or ‘Exchange’ depending on the Order
								type that can be consulted in the section 6 of the present
								Agreement.
							</p>
							<p>
								5.5. The User’s Order is registered in the System after
								verifying the availability of required amount of Funds on the
								Account. KOINKOIN controls the possibility of Users to carry out
								transactions and by this strengthens confidence between the
								Users and reduces the risk of non-execution of Users’
							...
							<p>
								5.6. User cannot place more than 20 (twenty) Orders at the same
								time. The System does not register Orders that exceed the
								indicated amount.
							</p>
							<p>
							...
							<p>
								...
								registers a Counter Order placed by another User. Counter Orders
								are reverse orders that have the same Exchange Rate. The
								registration of counter orders in the System is considered the
								User’s acceptance of the offer. The Order is considered executed
								at the moment of the counter order registration in the System.
							</p>
							<p>
							...
							<p>
								5.11. The execution of the Order is realized by transferring the
								corresponding Funds indicated in counter orders to Users
							...
							<p>
								...
								all the Users during a period of time determined by the KOINKOIN
								platform.
							</p>
							...
							<p>
								...
								corresponding form in the Personal Cabinet indicating the amount
								of Funds to buy and setting the Exchange Rate.
							</p>
							<p>
							...
							<p>
								6.2.1. A simple sell Order represents the User’s offer to sell a
								certain amount of Funds at the Exchange Rate set by the User.
							</p>
							<p>
								6.2.2. To place a simple sell Order the User has to fill the
								corresponding form in the Personal Cabinet indicating the amount
								of Funds to sell and setting the Exchange Rate.
							</p>
							<p>
								6.2.3. When placing a simple sell Order the User has the
								possibility to use additional functions of the System like ‘Stop
								Loss’ or ‘Trailing Stop’. Marking a special box opposite the
								corresponding field in the form for placing a simple sell Order
								is considered the ground for using these functions.
							</p>
							<p>
							...
							<p>
								...
								form the amount of Funds to sell as well as ‘Trailing Stop’ and
								‘Stop Loss’ values. The Funds will be offered for sale at a
								highest current Exchange Rate determined by the System. If the
								System Exchange Rate starts to raise and will increment by the
								value indicated in the box ‘Trailing Stop’, the Exchange Rate
								for the Order placed by the User will increment by a
								corresponding amount. Herewith ‘Stop Loss’ index will increment
								by the amount indicated in the box ‘Trailing Stop’.
							</p>
							...
							<p>
								6.4.1. A market sell Order represents the User’s offer to sell a
								certain amount of Funds without setting the Exchange Rate.
							</p>
							<p>
							...
							<p>
								6.5.1. A complex buy and sell Order represents the User’s offer
								to buy a certain amount of Funds at the Exchange Rate set by the
								User and to sell the acquired amount of Funds at the Exchange
								Rate set by the User. So, when the User places a complex buy and
								sell Order, the System in its turn places firstly a simple buy
								Order and when it is executed, places a simple sell Order.
							</p>
							<p>
								...
								the amount of Funds to buy and setting the Exchange Rate as well
								as setting the Exchange Rate to be used during the sale of the
								acquired Funds.
							</p>
							<p>
							...
							<p>
								...
								the "Loan"/ "Take a Loan" field, etc.) means the User's consent
								to the conditions for the implementation of Marginal
								Transactions.
							</p>
							<p>
								7.4. The loan agreement is considered concluded from the moment
								of crediting of Funds to the Account of the User.7.5. The funds
								are provided to Users on a refundable and onerous basis.
							</p>
							<p>
								7.5. The funds are provided to Users on a refundable and onerous
								basis.
							</p>
							<p>
							...
							<p>
								...
								the User in the placed Order, the System writes off the User
								Account the amount of Funds equivalent to the amount of Funds
								provided on the basis of loan agreement as well as the
								corresponding commission. The amount of commission is determined
								by the Fees.
							</p>
							<p>
								...
								Personal Cabinet until the User replenishes his/her Account for
								a sum equivalent to the amount of the debt. Herewith the User is
								obliged to replenish the corresponding Account during 5 (five)
								working days from the moment of acquiring these liabilities.
							</p>
							<p>
								7.10. In case of risk that the Margin Level on the User Account
								can result insufficient, the KOINKOIN has the right, at sole
								discretion and without previously notifying the User, to decide
								on the immediate execution of the Order or call it back. The
								above mentioned actions are not considered as a violation of
								obligations on behalf of the KOINKOIN.
							</p>
							<p>
								7.11. The User agrees that KOINKOIN has the right to execute a
								stop-loss at a Margin Level of less than 30% at a 1: 2 leverage,
								and this action is not a violation of the obligations of
								KOINKOIN.
							</p>
							<p>
								7.12. Tracking changes in the conditions for execution of
								Marginal transactions and compliance with the performance of
								margin requirements is a direct duty of the client. KOINKOIN is
								not liable for any losses that may result from a lack of
								...
								execution of the stop-loss (s), or about the sale or liquidation
								of the User's Funds from his Account in the System, if such
								account is not replenished as a result of arrears.
							</p>
							<h3>
								8. DETECTION AND PREVENTION OF ILLEGAL SITE AND SYSTEM USE
							</h3>
							<p>
								8.1. The User is prohibited to conduct Deals omitting the formal
								procedure of placing Orders by means of using personal messages
								and other options of the Site and/or the System. In these cases
								a message ceases to be private and becomes available for
								moderators and the administration if one of chat users
								complaints about it.
							</p>
							<p>
								8.2. The User is prohibited to use the Site and/or the System in
								any other way than those stipulated in the Agreement; in
								particular, the User is not allowed to advertise products on the
								Site in case the Parties have not entered an additional specific
								agreement.
							</p>
							<p>
							...
							<p>
								...
								process established by the System or third parties (aggregators,
								credit or other organs) during the Deal-making process as well
								as fulfil the requirements stipulated by UK law in the field of
								counteraction of laundering (legitimisation) proceeds of crime.
							</p>
							...
							<p>
								...
								<br />
								<i className="small fa fa-circle" /> Price volatility: The value
								of cryptocurrencies is extremely volatile. They are vulnerable
								to sharp changes in price due to unexpected events or changes in
								market sentiment.
								<br />
								<i className="small fa fa-circle" /> Leverage: Leverage
								multiplies User’s profits but also potential losses and can have
								a significant impact on fees. It also places User at risk of
								losing more than his/her initial investment.
								<br />
								<i className="small fa fa-circle" /> Charges and funding costs:
								Charges and Fees can include the spread, funding charges, and
								commissions.
								<br />
								<i className="small fa fa-circle" /> Price transparency: When
								compared with fiat currencies, there can be more significant
								variations in the pricing of cryptocurrencies used to determine
								the value of User’s position. There is a greater risk that the
								User will not receive a fair and accurate price for the
								underlying cryptocurrency when trading.
							</p>
							<p>
								9.2. User should only participate in trading deals if he/she has
								a sophisticated knowledge of financial markets and fully
							...
							<p>
								9.4. The User understands that KOINKOIN in no way influences the
								Exchange Rate set by the Users, does not give recommendations on
								Exchange Rate determination and does not forecast the rates. The
								User is responsible for all economic risks related to choosing
								particular Exchange Rate. The KOINKOIN does not guarantee that
								the Deal will be finally closed and that the conditions of this
								Deal will be of the User’s benefit.
							</p>
							<p>
								9.5. The User understands that the KOINKOIN in no way bear’s
								relation to deal conduction and/or transactions related to
								Cryptocurrency. Correspondingly the KOINKOIN does not assume the
								responsibility to guarantee terms and/or possibilities of
							...
							<p>
								10.2. By using the Site and the System the User acknowledges and
								agrees that all Site content and the structure of Site content
								are protected by copyright, trademark and other rights
								...
								System content are committed to the User as a result of Site and
								System use or on the conclusion of the Agreement.
							</p>
							<p>
								...
								the System except when this function is clearly contemplated by
								...
								its design;
								<br />
								<i className="small fa fa-circle" /> diffuse on the Site and/or
								in the System personal data of third persons without their
								permission;
								<br />
								<i className="small fa fa-circle" /> change in any way the
								program part of the Site and/or the System, take any actions
								aimed at changing the functionality and operability of the Site
								and/or the System;
								<br />
							...
							<p>
								...
								Agreement, the legislation of the UK, morality norms or in case
								he/she conspires with another User to violate the conditions of
								the Agreement, the KOINKOIN will have the right to block or
								delete the User’s Personal Cabinet, prohibit or restrict their
								access to certain or all functions of the System using his/her
								Personal Cabinet.
							</p>
							<p>
								11.2. In case the User violates the terms of the return of Funds
								provided under the Marginal Deal, KOINKOIN is entitled to demand
								from the User payment of a penalty amounted to 1% (one percent)
								of the Funds provided to the User for each day of delay.
							</p>
							<p>
								11.3. If the KOINKOIN detects that the User has violated
								paragraph 8 of the present Agreement, the KOINKOIN will have the
								right to delete the User’s Personal Cabinet and demand indemnity
								for losses.
							</p>
							<p>
								11.4. The KOINKOIN is not responsible for the operability of the
								Site and/or the System and does not guarantee its continuous
								operation. The KOINKOIN does not guarantee the safety of the
								information published on the Site and/or in the System as well
								as does not guarantee the possibility of continuous access to
								the information about Orders and closed Deals, the possibility
								of Order placement and of making Deals.
							</p>
							<p>
								11.5. The User uses the Site and the System in its original form
								at his/her own risk. The KOINKOIN does not guarantee the
								achievement of any results by the User owing to the Site and/or
								System use.
							</p>
							<p>
								11.6. The KOINKOIN does not guarantee that the Site and the
								System satisfy the requirements of the User as well as does not
								guarantee continuous, fast, save and error-free access to the
								Site and/or the System.
							</p>
							<h3>12. SPECIAL CONDITIONS</h3>
							<p>
								12.1. The Site and the System can contain external links to
								other sites in the Internet network (third parties’ sites). The
								abovementioned third parties’ sites and their content are not
								checked by criteria of conformity with certain requirements
								(authenticity, completeness, legality, etc.). The KOINKOIN will
								not be liable for the information and the materials published on
								third parties’ sites, which the User can access via the Site
								and/or the System as well as does not assume any responsibility
								for expressed opinions or statements, advertising materials, the
								accessibility and possible consequences of use of third parties’
								sites.
							</p>
							<p>
								...
								the User about it leaving the corresponding message on the Site
							...
							<p>
								...
								Cross-chain deposits is an inherently dangerous and a very time
								consuming process. Not all deposits can be recovered and
							...
							<p>
								...
								KOINKOIN'S affiliates, and KOINKOIN'S suppliers and distributors
								will be responsible for lost profits, revenues, financial
								losses, indirect, special, consequential, exemplary damages.
							</p>
							<p>
								14.2. To the extent permitted by law the total amount of
								KOINKOIN liability, its affiliates, and KOINKOIN'S suppliers and
								distributors is limited to the amount you paid to KOINKOIN for
								all Services provided during 3 (three) months prior to the event
								giving rise to the liability.
							</p>
							<p>
								14.3. KOINKOIN, its affiliates, and KOINKOIN'S suppliers and
								distributors will not be liable for any expense, loss or damage
							...
							<p>
								...
								directors and stockholders harmless from and against any and all
								damages claimed by a third party as a result of actions by User
								in violation of this Agreement. The User agrees to defend,
								indemnify and hold KOINKOIN, its affiliates and their respective
								employees, officers, directors and stockholders harmless from
								and against any and all damages for damages to property, bodily
								injury, death, or other injuries arising from the negligence or
								misconduct of the User or any person for whom User is legally
								responsible.
							</p>
							<p>
								15.2. The party seeking indemnification in any case shall
								promptly give written notice to the other of the claim for which
								indemnification is sought and shall cooperate with the other
								party in the defence of such an action or suit. The failure to
								give or delay in giving any such notice shall not limit the
								indemnifying party's rights hereunder except to the extent it is
								prejudiced thereby. The indemnifying party shall have the right,
								at its expense, to direct any such legal proceeding and the
								negotiation and settlement of any such claim or demand. The
								indemnifying party shall have no liability for any settlement
								made without its consent or for any fees or expenses incurred by
								the other party after the indemnifying party begins directing
							...
							<p>
								...
								promptly cure the breach and take due measures to eliminate the
								consequences. Any dispute arising out of or in connection with
								this Agreement (including a dispute regarding the existence,
								validity or termination of this Agreement or the consequences of
								its nullity) shall be referred to and finally resolved by
								arbitration under the Arbitration Rules of the London Court of
								International Arbitration
							</p>
							<p>
								16.3. If any dispute occurs as to the performance or
								interpretation of the present Agreement that cannot be resolved
								amicably or in arbitration the Company is entitled to demand the
								dispute be settled by the Court in location where the KOINKOIN
								resides.
							</p>
							<h3>17. AMENDMENTS OF THE AGREEMENT</h3>
							<p>
								17.1. The Service has the right to unilaterally change the terms
								of the Agreement, Privacy Policy, Anti-Money Laundering Policy
								and the Fees. The changes take effect 3 (three) days after the
								moment the new version of corresponding documents is published.
							</p>
							<p>
								17.2. At each successive visit to the Site and before starting
								the use of the Personal Cabinet the User commits to become
								familiar with the new version of the Agreement, Privacy Policy,
								Anti-Money Laundering Policy and the Fees. If the User continues
								to use the Site and the System it will mean that he/she agrees
								with new versions of the corresponding documents.
							</p>
							<p>
							...
							<p>
								...
								and the current legislation, all the notifications, messages and
								documents related to the fulfilment of obligations from the
								Agreement should be sent to and are considered as received by
								the Parties if they have been sent via email from the authorized
								address of one Party to the authorized address of the other
								Party. An authorised address can be:
								<br />
								...
								<a className="bright_color" href="mailto:support@koinkoin.com">
							...
							<p>
								...
								account its conflict rules. Any disputes are solved according to
