				...
				<div className="about_us_text_wrap">
					<div className="about_us_text">
						<div className="policy_text_inner">
							<p>
								KoinKoin and its affiliates (hereinafter “KoinKoin”, “we”, “us”
								or “our”) undertakes to take maximum efforts in order to protect
								your privacy. KoinKoin uses the collected information about you
								to fulfil its contractual obligations and improve the customer
								service.{' '}
							</p>
							<p>
								This policy together with the User Agreement and other documents
								referred to it defines the principles and rules on the basis of
								which we collect process and use your personal data.{' '}
							</p>
							<p>
								Please read this document carefully in order to understand our
								approach and policy regarding your personal data and how we will
								use your personal data.{' '}
							</p>
							<p>
								For the purpose of the Data Protection Act 1998 (the "Act"), the
								data controller is KoinKoin LTD a legal entity registered
								...
								KOINKOIN) and was incorporated under the International Business
								Companies Act of 1994 of the Republic of Seychelles with a
								company number of 204414 and registered address of Global
								Gateway 8, Rue de la Perl, Providence, Mahe, Seychelles{' '}
							</p>
							<h3>1. WHAT WE COLLECT ABOUT YOU</h3>
							<p>We may collect and process the following data about you:</p>
							<h4>Information you give to us.</h4>
							<p>
								You can provide us with information about yourself by filling in
								the relevant forms on the website or by providing us such
								information by phone, email, during a video conference or in any
								other manner. This information includes personal data which was
								specified when registering on the website, when subscribing to
								our service , opening an account and verifying the identity of
								the account holder or persons authorised to use it, as well as
								the payment instruments used by a person, when searching for a
								product, using any of services provided by our website, while
								placing orders on our website, by participating in discussions
								or using any other communication functions on our website,
								during participation in draws, promotions or surveys, and also
								when you tell us about problems or issues in the work of the
								website. For example, the data that you provide us, can include
								your last name and first name, your photos; your videos, your
								address; your nationality, your tax residency, your phone
								number; your e-mail address; your logins and nicknames, your
								bank details, including account numbers and payment details;
								your date of birth; your education; your experience and place of
								work, your sources of income and their amount; information on
								the status of your accounts opened with banks or payment
								systems.
							</p>
							<h4>Information we collect about you.</h4>
							<p>
								With regard to each of your visits to our website and use our
								services we can collect, for example, the following information
								about you (including automatically):
							</p>
							<ul className="agreement_list">
								<li className="agreement_text_node">
									...
									your computer to the internet, your login information, browser
								...
								<li className="agreement_text_node">
									...
									time); products you viewed or searched for; page response
								...
								<li className="agreement_text_node">
									...
									information from your device at any time while you download or
									use our services. We may use this information to optimize your
									experience.
								</li>
								<li className="agreement_text_node">
									<span className="wrap_ico">
									...
									provided by our website, including information on implemented
									transactions and parties thereto, including on margin
									transactions, information on the status and (crypto) currency
									of accounts and cash flow on them, accrued commissions,
									information on crediting and withdrawal of funds from our
									accounts.
								</li>
							</ul>
							...
							<p>
								...
								websites we operate or the other services we provide. We are
							...
							<p>
								...
								which assigns a unique identification to your computer. We also
								may use cookies stored in emails to help us confirm your receipt
								of, and response to. We also may use service provider(s) who
								will place cookies on the hard drive of your computer and will
								receive information that we select that will give us information
								about the way our users and visitors navigate on our site, what
								products are browsed, and general transaction information.
							</p>
							<p>
								Information collected from cookies is used by us to evaluate the
								effectiveness of our site, analyse trends, see what difficulties
								our visitors may experience in accessing our site, and
								administer the platform. We need this information to improve the
							...
							<ul className="agreement_list">
								<li className="agreement_text_node">
									...
									to fulfill the obligations provided by any contracts concluded
									with you, as well as to provide you with the information,
									products and services that you requested;
								</li>
								<li className="agreement_text_node">
									<span className="wrap_ico">
										<i className="fa fa-circle" />
									</span>
									to verify and check the identity of users who open and operate
									accounts in order to prevent fraud, deception and other
									illegal activities;
								</li>
								<li className="agreement_text_node">
									<span className="wrap_ico">
								...
								<li className="agreement_text_node">
									...
									to provide you by us or by third parties appointed by us with
									information about products or services that you, in our
									opinion, might be interested in. If you are already our
									customer, we will contact you via electronic means of
									communication (via e-mail or SMS) to inform you about products
									or services similar to those that were in a previous sale or
									negotiations to sell them to you. If you are a new customer
									and since we allow certain third parties to use your data, we
									(or they) will contact you only by electronic means and only
									upon your consent. If you do not want us to use your data in
									this way or transfer it to third parties for marketing
									purposes, please tick the appropriate box on the form in which
								...
								<li className="agreement_text_node">
									...
									for administration of our website and for internal operations,
									including troubleshooting, data analysis, testing, statistical
									data collection and for conducting surveys;
								</li>
								<li className="agreement_text_node">
									<span className="wrap_ico">
										<i className="fa fa-circle" />
								...
								<li className="agreement_text_node">
									...
									to give you access to the interactive features of the website
									in case you wish to use them;
								</li>
								<li className="agreement_text_node">
									<span className="wrap_ico">
										<i className="fa fa-circle" />
									</span>
									to ensure the security of our website, our services, and your
									accounts;
								</li>
								<li className="agreement_text_node">
									<span className="wrap_ico">
							...
							<ul className="agreement_list">
								...
								<li className="agreement_text_node">
									...
									the user in accordance with any applicable laws or within the
									implementation of decisions of the relevant courts, or we are
									compelled to force users to comply with the terms and
									conditions of the agreements concluded with us; in case it is
									necessary to protect own rights, own property, to guarantee
									the safety of KoinKoin, our users or others. This includes the
									exchange of information with companies and organizations to
									prevent fraud and reduce the likelihood of default by
									borrowers in conducting margin transactions.
								</li>
							</ul>
							...
							<p>
								...
								confidential. The security measures in place will, from time to
								time, be reviewed in line with legal and technical developments.
							</p>
							<p>
								The information we receive from you can be transferred and
								stored outside the European Economic Area (EEA). The information
								about you can be processed by our employees or employees of
								service providers outside the EEA. When storing or otherwise
								processing information by such third parties outside the EEA, we
								guarantee that we will notify such third parties of our
								obligations under this Privacy Policy and will enter with them
								into relations that will impose obligations for them regarding
								your personal data, which are at least have level of protection
								as specified in this Privacy Policy. Such employees, among other
								things, can process your requests, payment details and provide
								technical support. By giving us your personal data, you consent
								to the transfer, storage and processing of your personal data.
								In its turn, we will take all necessary measures to ensure that
								your personal data is processed in compliance with the security
								rules and in accordance with the provisions of this Privacy
								Policy.
							</p>
							<p>
								...
								your data transmitted to our site, and any transmission is at
								your own risk. Once we have received your information, we will
							...
							<p>
								...
								with a legal obligations (in cases where KoinKoin is required to
								request / receive and process as well as to store your personal
								data in order to comply with the requirements of applicable
								laws, for example the laws related to legalization (laundering)
								of proceeds of crime, financing of terrorism and financing the
								proliferation of weapons of mass destruction) and legitimate
								interest (for example, when processing is necessary to protect
								you or us from certain threats (fraud, security, etc.),
								compliance with the provisions of applicable laws, the proper
								level of conduct of our business (the quality of the services
								provided, identification of needs, preparation of reports),
								conclusion and implementation of corporate transactions (sale of
								participant interests / shares, mergers, acquisitions), etc.).
							</p>
							<p>
								In cases where the basis for data processing is the consent, you
							...
							<ul className="agreement_list">
								...
								<li className="agreement_text_node">
									...
									the right to access to your data and / or a copy of your data,
									which you provided to KoinKoin, in a machine-readable format.
								</li>
							</ul>
							<p>
								Also, you have the right to prohibit the use of your personal
								data for marketing purposes. Before requesting your personal
								information, we usually inform you that we are going to use your
								data or disclose it to third parties for promotional purposes.
								You can use the right to prohibit the processing of your
								personal data for promotional purposes by putting a tick in the
								relevant field in the questionnaire. You can also exercise this
								right by contacting us at any time.
							</p>
							<p>
								Please note that the implementation of some of your rights,
								depending on the situation, may limit, complicate or completely
								exclude the possibility of further cooperation.
							</p>
							<p>
								Our website can contain active links from / to the websites of
								partner organizations, advertisers and affiliated companies. If
								you are following an active link, please note that other
								websites have their own privacy policies, and we are not
								responsible for the provisions of these policies. Please review
								the privacy policies of these sites before sharing your personal
							...
							<p>
								...
								conditions, or in other cases to prevent possible harm based on
								our reasonable considerations.
							</p>
